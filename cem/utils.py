...
from cem.SaliencyModel.utils import vis_saliency
import yaml
...
if __name__ == "__main__":
    plot_heatmap_PSNR(max_value = 6.72, min_value = -0.24, prefix="DEMO", ROI_size=32, block_size=2, Model_name="ATD-light", Image_name="denseresidential_370.png", lower_bound=-6,
                      upper_bound=6,task="SR")
