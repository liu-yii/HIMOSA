...
from cem.ModelZoo.utils import Tensor2PIL
from cem.ModelZoo import load_model
from cem.SaliencyModel.utils import pil_to_cv2, calculate_psnr
from cem.utils import Get_Intervention_Dataset, load_psnr_data
from cem.utils import RainGenerator,extract_first_number_from_image_name
...
def main(config):
    ...
    for Model_name in Modellist:
        ...
        for Image_name in Imagelist:
            ...
            output_folder = os.path.join(f'./cem/{task}-CEM', f'{prefix}-R{ROI_size}M{mask_block_size}', Model_name)
            ...
            sio.savemat(
                f'./cem/{task}-CEM/{prefix}-R{ROI_size}M{mask_block_size}/{Model_name}/{Image_name}-PSNR-Origin.mat',
                {'PSNR': psnr_origin})
