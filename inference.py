...
model_path = {
    "classical": {
        "2": "pretrained_models/PFTNet/001_PFT_SRx2_scratch.pth",
        "3": "pretrained_models/PFTNet/002_PFT_SRx3_finetune.pth",
        "4": "pretrained_models/PFTNet/003_PFT_SRx4_finetune.pth",
    },
    "lightweight": {
        "2": "pretrained_models/PFTNet/101_PFT_light_SRx2_scratch.pth",
        "3": "pretrained_models/PFTNet/102_PFT_light_SRx3_finetune.pth",
        "4": "pretrained_models/PFTNet/103_PFT_light_SRx4_finetune.pth",
    }
}

def get_parser(**parser_kwargs):
    parser = argparse.ArgumentParser(**parser_kwargs)
    parser.add_argument("-i", "--in_path", type=str, default="demo/AID/lr/airport_6.png", help="Input image or directory path.")
